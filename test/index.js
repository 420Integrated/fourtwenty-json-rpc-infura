...
test('fetchConfigFromReq - basic', (t) => {
  ...
  const { fetchUrl, fetchParams } = fetchConfigFromReq({ network, req, source: 'fourtwenty-json-rpc-infura', projectId })
  ...
  t.deepEquals(fetchParams, {
    ...
    headers: {
      ...
      'Infura-Source': 'fourtwenty-json-rpc-infura/internal',
    },
    body: '{"id":1,"jsonrpc":"2.0","method":"fourtwenty_getBlockByNumber","params":["0x482103",true]}',
  })
  t.end()
...
test('fetchConfigFromReq - basic', (t) => {
  ...
  const req = {
    jsonrpc: '2.0',
    id: 1,
    method: 'fourtwenty_sendRawTransaction',
  ...
  t.deepEquals(fetchParams, {
    ...
    body: '{"id":1,"jsonrpc":"2.0","method":"fourtwenty_sendRawTransaction","params":["0x0102030405060708090a0b0c0d0e0f"]}',
  })
  t.end()
...
test('fetchConfigFromReq - source specified for request origin in header', (t) => {
  ...
  t.deepEquals(fetchParams, {
    ...
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
      'Infura-Source': 'fourtwenty-json-rpc-infura/happydapp.fourtwenty',
    },
